...
def parse_args():
    ...
    parser.add_argument(
        '--vis-output', action='store_true', help='visualize output maps'
    )
    parser.add_argument(
        '--pavi', action='store_true', help='use PAVI instead of tensorboard'
    )
    parser.add_argument(
        '--highlight',
        type=str,
    ...
    parser.add_argument(
        '--num-vis', type=int, default=10, help='number of to-visualize images'
    )
    parser.add_argument(
        '--black-bg',
        action='store_true',
        help='black out the background pixels with ground truth',
    )
    parser.add_argument(
        '--gpu-collect',
        action='store_true',

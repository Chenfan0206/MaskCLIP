...
class VisionTransformerDPT2(BaseModule):
    """Vision Transformer.
    ...
    def __init__(
        ...
        super(VisionTransformerDPT2, self).__init__(init_cfg=init_cfg)
    ...
    def init_weights(self):
        if (
            ...
            super(VisionTransformerDPT2, self).init_weights()
        else:
